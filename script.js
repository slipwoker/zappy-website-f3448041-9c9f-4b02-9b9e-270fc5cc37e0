document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const showError = (input, message) => {
            ...
            error.style.cssText = 'color: #dc2626; font-size: 0.875rem; margin-top: 0.25rem; display: block;';
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            if (isValid) {
                ...
                setTimeout(() => {
                    ...
                    successMsg.style.cssText = 'color: #16a34a; padding: 1rem; margin-top: 1rem; text-align: center;';
    ...
    if (animatedElements.length > 0) {
        ...
        // Handle RTL for fade-in directions
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'f3448041-9c9f-4b02-9b9e-270fc5cc37e0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'f3448041-9c9f-4b02-9b9e-270fc5cc37e0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'f3448041-9c9f-4b02-9b9e-270fc5cc37e0';
